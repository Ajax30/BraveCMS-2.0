...
<script>
    document.addEventListener('DOMContentLoaded', () => {
        ...
        const messages = {
            ...
            password_min_length: `The password must have at least ${minPasswordLength} characters.`,
            ...
            emailTimeout = setTimeout(() => {
                fetch('{{ route('check.email') }}', {
                    ...
                    .then(data => {
                        ...
                        toggleError(fields.email, emailUnique, data.message || messages
                            .email_exists);
                    })
                    .catch(() => {
                        emailUnique = false;
        ...
        function validateFormOnSubmit(e) {
            ...
            if (!fields.password.value || fields.password.value.length < minPasswordLength || !passwordRegex
                .test(fields.password.value)) valid = false;
            if (!fields.passwordConfirm.value || fields.passwordConfirm.value !== fields.password.value) valid =
                false;
