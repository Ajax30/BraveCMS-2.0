    ...
    <nav class="navbar sticky-top navbar-expand-md navbar-dark bg-dark">
      <div class="container">
        ...
        <div class="collapse navbar-collapse" id="mainNavigation">          
              ...
              <li class="nav-item dropdown">
                ...
                <ul class="dropdown-menu navbar-dropdown-menu">
                  @foreach ($pages as $page)
                    <li><a class="dropdown-item" href="{{ url('/page/' . $page->id) }}">{{ $page->title	}}</a></li>
                  @endforeach
                </ul>
              </li>
            @endif
          ...
          <form method="get" action="{{ url('/') }}" class="search_form w-100 pe-md-2 mx-auto mt-2 mt-md-0" role="search">
            <div class="input-group">
              <input class="form-control search-box" name="search" type="search" placeholder="Search articles..." aria-label="Search">
